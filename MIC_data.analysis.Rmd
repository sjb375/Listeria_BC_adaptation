...
```{r}
fit7<-lmer(log2(foldchange)~mono.spp+fold_compare+(1|Strain),data=subset(FoldChange,fold_compare=="Fold_substreaked_parent"|fold_compare=="Fold_serial_parent"))
summary(fit7)
Anova(fit7,type="III")
...
fit8<-lmer(log2(foldchange)~ResistanceGene+fold_compare+(1|Strain),data=subset(FoldChange,fold_compare=="Fold_substreaked_parent"|fold_compare=="Fold_serial_parent"))
summary(fit8)
Anova(fit8,type="III")
...
fit9<-lmer(log2(foldchange)~fold_compare+(1|Strain),data=subset(FoldChange,fold_compare=="Fold_substreaked_parent"|fold_compare=="Fold_serial_parent"))
summary(fit9)
Anova(fit9,type="III")
